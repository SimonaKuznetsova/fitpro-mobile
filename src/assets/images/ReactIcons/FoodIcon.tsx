...
const FoodIcon = ({width = 36, active}) => {
  return (
    <Svg
      version="1.1"
      ...
      <G>
        <G>
          <Path
            fill={`${active ? '#ffae2b' : '#868687'}`}
            className="open_een"
            d="M12.5,9C12.776,9,13,8.776,13,8.5v-6C13,2.224,12.776,2,12.5,2S12,2.224,12,2.5v6
			C12,8.776,12.224,9,12.5,9z"
          />
          <Path
            fill={`${active ? '#ffae2b' : '#868687'}`}
            className="open_een"
            d="M9.5,9C9.776,9,10,8.776,10,8.5v-6C10,2.224,9.776,2,9.5,2S9,2.224,9,2.5v6C9,8.776,9.224,9,9.5,9z"
          />
          <Path
            fill={`${active ? '#ffae2b' : '#868687'}`}
            className="open_een"
            d="M15.5,2C15.224,2,15,2.224,15,2.5V9c0,1.693-1.071,3.208-2.666,3.772
          ...
          <Path
            fill={`${active ? '#ffae2b' : '#868687'}`}
            className="open_een"
            d="M22.852,2c-1.021,0-1.907,0.727-2.107,1.727L18.488,15.01c-0.147,0.737,0.042,1.494,0.518,2.075
